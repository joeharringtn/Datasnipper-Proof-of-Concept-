...
class ConfigManager:
    ...
    def load_config(self) -> ConfigObject:
        ...
        Returns:
            ConfigObject with all loaded configuration

        Raises:
            ConfigError: If configuration is incomplete or invalid
        """
        try:
            self.load_timestamp = datetime.now()

            # Load basic engagement metadata
            ...
            # Create ConfigObject with validation
    ...
    def validate_config(self) -> tuple[bool, list[str]]:
        ...
        # Validate approval workflow if multi-level
        if (
    ...
    def _load_documents(self) -> list[DocumentSpec]:
        ...
        doc_rows = self.excel_mgr.read_rows_as_dicts("CONFIG")

        # For now, documents are expected to be manually populated in CONFIG
        # This is a placeholder for future enhancement to support multi-document configs
